<template>
  <ul>
    <li class="box8">
      <div class="top">
        <h1 class="tit">Inbound By Region</h1>
        <a href="#" class="more"><img src="../../public/images/Group9.6.png"></a>
        <p>Frequency of emergency dispatch request service by region</p>
      </div>
      <img style="width:80%;display: inline-block" src="../../public/images/map.png" alt="">
      <img class="img_left" style="margin-bottom: 40%;width:20%;display: inline-block" src="../../public/images/Group867.png" alt="">
    </li>
  </ul>
...
<!--변경 시작 - RowInboundByRegion-->
<style scoped>
main .box8{margin-bottom: 35px;position: relative;background: #212144;border-radius: 20px;padding: 40px;box-shadow: 0 4px 10px rgba(0, 0, 0, .4);text-align: center;margin-bottom: 0;}
main .box8 p{ margin-top: 30px; line-height: 45px; font-size: 35px; float: right; color: #fff; width: 35%; margin-right: 20px}
@media(max-width:1000px) { main .box8 p{ font-size: 20px; line-height: 20px}
  main .box8 .img_left{ margin-bottom: 30%}
